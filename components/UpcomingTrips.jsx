...
export default function UpcomingTrips () {
  ...
  return (
    <section className='relative w-full py-20 bg-gradient-to-b from-yellow-400 to-yellow-600 text-white text-center overflow-hidden'>
      ...
      <div className='relative flex items-center justify-center max-w-5xl mx-auto mt-10'>
        <button
          onClick={prevTrip}
          className='absolute left-0 p-4 bg-white/20 rounded-full hover:bg-white/40 transition'
        >
        ...
        <motion.div
          key={index}
          className='relative w-full max-w-lg p-6 bg-white rounded-lg shadow-2xl text-gray-900'
        ...
        >
          ...
          />
          <h3 className='mt-4 text-2xl font-bold'>{trips[index].title}</h3>
          ...
          <Link href='/book-now'>
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className='px-6 py-3 mt-4 text-lg font-semibold text-white uppercase bg-yellow-500 rounded-full shadow-lg hover:bg-yellow-600 transition-all'
            >
              Book Now
            </motion.button>
          </Link>
